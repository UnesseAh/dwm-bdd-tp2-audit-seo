...
// Fetch only textiles items from the database
$stmt = $pdo->prepare("SELECT * FROM products WHERE category = 'textiles'");
$stmt->execute();
...
<head>
    ...
    <meta name="description" content="Découvrez les textiles marocains : tapis berbères, caftans, djellabas et couvertures fabriqués selon un savoir-faire artisanal.">
    <style>
        body {
